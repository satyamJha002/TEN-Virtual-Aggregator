...
const VirtualNavbar = () => {
    ...
    const activeStyle = "text-[#000] font-semibold";
    ...
    return (
        <nav className="navbar">
            <div className="navbar-brand">
                ...
                <svg  className="Logo"  preserveAspectRatio="xMidYMid meet" data-bbox="0.36 0.279 243.208 201.268" viewBox="0 0 243.913 201.792"
         height="100" width="100"   xmlns="http://www.w3.org/2000/svg" data-type="ugc" role="presentation" aria-hidden="true">
        <g>
        <g opacity=".86">
            ...
            <path strokeWidth=".5" strokeMiterlimit="10" stroke="#e9b00d" fill="#e9b00d" d="M131.695 13.481l10.313 10.93c8.623-9.169 22-9.609 29.407-2.745a18.567 18.567 0 0 1 3.52 22.368c-4.8 8.166-16.367 11.4-26.011 6.16a196.508 196.508 0 0 1-28.915-27.278 110.45 110.45 0 0 0-18.478-17.477c-2.165-1.619-3.96-2.165-8.923-3.766-8.5-2.728-19.587-.9-28.281 5.28a34.757 34.757 0 0 0-13.586 36.711 34.687 34.687 0 0 0 26.521 24.638c11.07 2.217 23.723-1.021 30.939-9.063a28.172 28.172 0 0 0 1.883-2.393L99.257 45.529c-.422.581-6.776 8.9-16.842 8.166a18.954 18.954 0 0 1-17.331-17.722 18.831 18.831 0 0 1 13.2-18.6 19.851 19.851 0 0 1 20.1 5.913c5.192 5.385 8.553 7.884 23.142 23 5.86 6.089 5.614 5.79 6.916 7.039 5.438 5.28 10.348 9.943 16.719 12.565 12.618 5.28 25.272-.141 26.644-.757a34.969 34.969 0 0 0 17.352-16.6c.6-1.267 7.48-16.3-.757-31.044A34.7 34.7 0 0 0 151.811.916a35.391 35.391 0 0 0-20.116 12.565z"></path>
                ...
                <div className="title">TEN VIRTUAL AGGREGATOR</div>
            </div>
            ...
            <ul className="nav-links">
                <li>
                    <NavLink
                        to="/"
                        className={({ isActive }) =>
                            `${isActive ? activeStyle : inactiveStyle} hover:text-[#000000s]`
                        }
                    >
                        Home
                    </NavLink>
                ...
                {/* Dropdown for Scientific Events */}
                <li
                    className="dropdown"
                ...
                >
                    ...
                    {hoveredDropdown === "events" && (
                        <ul className="dropdown-menu">
                            <li>
                                <NavLink
                                    to="/ScientificEvents/india"
                                    className={({ isActive }) =>
                                        `${isActive ? activeStyle : inactiveStyle} dropdown-box`
                                    }
                                >
                                    India
                                </NavLink>
                            ...
                            <li>
                                <NavLink
                                    to="/ScientificEvents/international"
                                    className={({ isActive }) =>
                                        `${isActive ? activeStyle : inactiveStyle} dropdown-box`
                                    }
                                >
                ...
                {/* Dropdown for Add Events */}
                <li
                    className="dropdown"
                    onMouseEnter={() => handleMouseEnter("addEvents")}
                    onMouseLeave={handleMouseLeave}
                >
                    <button className="dropdown-toggle" aria-haspopup="true">
                        Add Events
                        <span className="arrow">
                            {hoveredDropdown === "addEvents" ? "▲" : "▼"}
                        </span>
                    </button>
                ...
                <li>
                    <NavLink
                        to="/ContactUs"
                        className={({ isActive }) =>
                            `${isActive ? activeStyle : inactiveStyle} hover:text-[#000]`
                        }
                    >
                        CONTACT US
                    </NavLink>
