  ...
  return (
    <nav className="flex justify-around items-center px-6 py-4 bg-[#80011f] text-white relative z-50 navbar">
      <div className="flex items-center">
        ...
        <a href="https://example.com/ten-virtual-aggregator" target="_blank">
      ...
      {mobileMenuOpen && (
        <ul
          className="lg:hidden absolute top-full left-0 w-full bg-[#80011f] text-white flex flex-col space-y-4 p-4"
          style={{ zIndex: "" }}
        >
          <li>
            <NavLink
